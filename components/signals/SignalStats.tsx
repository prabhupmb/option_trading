...
const SignalStats: React.FC<{ signals: SmartSignal[] }> = ({ signals }) => {
    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div className="bg-[#1a1f2e] border border-gray-800 p-4 rounded-xl flex items-center justify-between">
                <div>
                    <p className="text-gray-400 text-xs font-bold uppercase tracking-widest">Total Signals</p>
                    <h3 className="text-2xl font-mono text-white mt-1">{signals.length}</h3>
                </div>
            ...
            <div className="bg-[#1a1f2e] border border-gray-800 p-4 rounded-xl flex items-center justify-between">
                <div>
                    <p className="text-gray-400 text-xs font-bold uppercase tracking-widest">Buy / Sell Ratio</p>
            ...
            <div className="bg-[#1a1f2e] border border-gray-800 p-4 rounded-xl flex items-center justify-between">
                <div>
                    <p className="text-gray-400 text-xs font-bold uppercase tracking-widest">Hold / Wait</p>
                    <div className="flex gap-4 mt-1">
            ...
            <div className="bg-[#1a1f2e] border border-gray-800 p-4 rounded-xl flex items-center justify-between relative overflow-hidden group">
                <div className="z-10 relative">
                    <p className="text-gray-400 text-xs font-bold uppercase tracking-widest">Market Sentiment</p>
