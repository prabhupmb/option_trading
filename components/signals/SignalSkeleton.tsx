...
const SignalSkeleton: React.FC = () => {
    return (
        <div className="bg-white dark:bg-[#1a1f2e] border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden p-5 animate-pulse">
            <div className="flex justify-between mb-4">
                ...
                <div className="text-right space-y-2">
                    <div className="w-20 h-8 bg-gray-200 dark:bg-gray-800 rounded ml-auto"></div>
                    <div className="w-16 h-4 bg-gray-200 dark:bg-gray-800 rounded ml-auto"></div>
                </div>
            </div>

            <div className="grid grid-cols-4 gap-4 py-4 border-y border-gray-200 dark:border-gray-800 mb-4">
                {[1, 2, 3, 4].map(i => (
            ...
            <div className="flex gap-2 mb-4">
                <div className="w-full h-10 bg-gray-200 dark:bg-gray-800 rounded"></div>
            </div>
        </div>
    );
};
