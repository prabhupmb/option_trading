...
const SignalFeed: React.FC = () => {
    ...
    const handleStockRefresh = async () => {
        ...
        try {
            ...
            await fetch('https://prabhupadala01.app.n8n.cloud/webhook/refersh-stock', {
                method: 'POST',
            ...
            <div className="max-w-[1600px] mx-auto p-6 lg:p-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                        ...
                        <button onClick={handleStockRefresh} disabled={loading || refreshing}
                            ...
                            <span className={`material-symbols-outlined text-sm ${loading || refreshing ? 'animate-spin' : ''}`}>refresh</span> {refreshing ? 'Refreshing...' : 'Refresh'}
                        </button>
