...
const EODBanner: React.FC<{ isOpen: boolean }> = ({ isOpen }) => {
    ...
    const styles = {
        gray: 'bg-[#21262d] border-[#30363d] text-gray-400',
    ...
    return (
        <div className="space-y-2">
            <div className="relative h-8 rounded-lg overflow-visible bg-[#1e2430] border border-[#30363d]">
                ...
                <div className="absolute -top-1 w-3 h-3 bg-[#ffd32a] rounded-full border-2 border-[#1e2430] z-10"
            ...
            <div className="p-5 space-y-4">
                ...
                <div className="flex justify-between items-start">
                    <div className="flex items-center gap-2.5 flex-wrap">
                        <span className="text-2xl font-black text-white tracking-tight">{pos.symbol}</span>
                ...
                <div className="bg-[#0d1117] rounded-xl p-4 border border-[#21262d]">
                    <div className="grid grid-cols-2 gap-x-6 gap-y-2.5 text-xs">
                        ...
                        <div className="flex justify-between"><span className="text-gray-500 font-bold">📊 R:R</span><span className="font-mono font-bold text-white">1:{(pos.risk_reward_ratio || 0).toFixed(1)}</span></div>
                    </div>
...
const DayCloseModal: React.FC<{ pos: DayPosition | null; onClose: () => void; onConfirm: (p: DayPosition) => void; closing: boolean }> = ({ pos, onClose, onConfirm, closing }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm" onClick={onClose}>
            <div className="w-full max-w-md bg-[#161b22] border border-[#30363d] rounded-2xl shadow-2xl" onClick={e => e.stopPropagation()}
                ...
                <div className="p-5 space-y-4">
                    ...
                    <div className="flex gap-3">
                        <button onClick={onClose} className="flex-1 py-3 border border-[#30363d] text-gray-400 font-bold rounded-xl hover:bg-[#21262d] text-xs uppercase">Cancel</button>
...
const DaySkeleton: React.FC = () => (
    <div className="bg-[#161b22] rounded-xl border border-[#30363d] p-5 space-y-4 animate-pulse">
        ...
        <div className="h-5 w-48 bg-[#21262d] rounded-full" />
        <div className="h-24 bg-[#0d1117] rounded-xl" />
    ...
    return (
        <div className="flex-1 overflow-y-auto bg-[#0d1117] min-h-screen text-white font-sans">
            <div className="max-w-[1600px] mx-auto p-6 lg:p-8 space-y-6">
                ...
                {/* ── Header ── */}
                <div className="bg-gradient-to-r from-[#161b22] to-[#1c2333] rounded-2xl border border-[#30363d] p-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="text-right">
                                <span className="block text-2xl font-black font-mono text-white tabular-nums">
                    ...
                    <div>
                        {loadingPositions ? (
                            ...
                            <div className="text-center py-20 bg-[#161b22] rounded-2xl border border-[#30363d]">
                                ...
                                <h3 className="text-lg font-black text-white uppercase tracking-tight mb-2">Iron Gate Day is Scanning</h3>
                ...
                {activeSection === 'history' && (
                    <div>
                        {loadingHistory ? (
                            <div className="space-y-3">{[1, 2, 3].map(i => <div key={i} className="h-12 bg-[#161b22] rounded-lg border border-[#30363d] animate-pulse" />)}</div>
                        ) : history.length === 0 ? (
                            <div className="text-center py-20 bg-[#161b22] rounded-2xl border border-[#30363d]">
                                <div className="text-6xl mb-4">📊</div>
                                        ...
                                        <table className="w-full text-xs">
                                            ...
                                            <tbody>
                                                {history.map(h => {
                                                    ...
                                                    return (
                                                        <tr key={h.id} className={`border-b border-[#21262d] ${isWin ? 'bg-[#00d97e]/[0.03]' : isEod ? 'bg-amber-500/[0.03]' : 'bg-[#ff4757]/[0.03]'}`}>
